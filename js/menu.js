class MobileNavbar{
    constructor(mobileMenu, navList, navLinks, hamburgerIcon, closeIcon){
         this.mobileMenu = document.querySelector(mobileMenu);
            this.navList = document.querySelector(navList);
            this.navLinks = document.querySelectorAll(navLinks);
            this.hamburgerIcon = document.querySelector(hamburgerIcon);
    ...
    handleClick(){
        ...
        this.hamburgerIcon.style.display = isActive ? "none" : "block";
